...
export const MailIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" {...props}>
    <path d="M3 5h18v14H3z" stroke="currentColor" strokeWidth="1.4" />
    <path d="M3 6l9 7 9-7" stroke="currentColor" strokeWidth="1.4" />
  </svg>
);
...
export const CaretIcon = (props) => (
  <svg className="caret" viewBox="0 0 10 10" fill="none" {...props}>
...
export const PlugIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" {...props}>
    <path d="M7 2v6M12 2v6M17 2v6M5 8h14l-1 5a6 6 0 0 1-12 0L5 8z" />
...
export const WhatsAppIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18" {...props}>
    ...
    <path d="M12 2C6.477 2 2 6.477 2 12c0 2.137.656 4.12 1.78 5.76L2.5 22l4.38-1.252A9.956 9.956 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18a7.95 7.95 0 0 1-4.108-1.137l-.295-.175-2.602.743.757-2.54-.192-.308A7.956 7.956 0 0 1 4 12c0-4.411 3.589-8 8-8s8 3.589 8 8-3.589 8-8 8z" />
  </svg>
);