...
export const BRANDS = [
  ...
  {
    slug: "masar-cable-trays",
    aliases: ["masar", "masar-cable-tray", "masar-trays", "masar-cable-trays"],
    name: "Masar Cable Trays",
    init: "MC",
    cat: "Cable Trays & Trunking",
    tagline: "Heavy-Duty Galvanised & Stainless Steel Cable Containment Solutions",
    catalogueTitle: "Masar Cable Trays, Ladders & Support Containment Catalogue",
    desc: "Masar is a premier manufacturer of heavy-duty industrial cable containment systems, specialising in hot-dip galvanised and pre-galvanised perforated cable trays, cable ladders, wire mesh baskets, and support channel unistrut accessories. Designed to support heavy power cabling across commercial complexes, industrial plants, and utility substations, Masar containment systems deliver high load-bearing capacity, superior corrosion protection, and fast, modular installation.",
    logo: null,
    highlights: [
      "Hot-Dip Galvanised (BS EN ISO 1461) & Pre-Galvanised Steel",
      "Heavy-Duty Perforated Trays, Cable Ladders & Wire Mesh Baskets",
      "Complete Fitting Range: Bends, Equal/Unequal Tees, Risers & Reducers",
      "Unistrut Channels, Cantilever Arms, Threaded Rods & Fasteners in Stock",
    ],
    rangeItems: [
      "Perforated Galvanised Cable Trays (50mm – 900mm Widths)",
      "Heavy-Duty Industrial Cable Ladder Racks & Wide Support Spans",
      "Wire Mesh & Basket Trays for High-Density Data & Power Routing",
      "Equal & Unequal Tees, 90° Flat Bends, Inside/Outside Risers & Reducers",
      "Slotted Unistrut Channels, Base Plates & Cantilever Support Arms",
      "Snap-On & Flanged Protective Covers for Dust & Weather Protection",
    ],
    products: [
      {
        name: "Masar Heavy-Duty Perforated Cable Trays (50mm – 900mm)",
        ...
        specs: [
          ...
          ["Widths", "50mm up to 900mm Available"],
          ["Standard", "BS EN 61537 / NEMA VE 1 Compliant"],
        ],
      },
      {
        name: "Masar Heavy-Duty Welded Cable Ladders",
        ...
        specs: [
          ...
          ["Finish", "Hot-Dip Galvanised to ISO 1461"],
          ["Applications", "Substations, Factories, Heavy Infrastructure"],
        ],
      },
      {
        name: "Masar 90° Flat Bends, Tees & Intersection Crosses",
        model: "Masar Modular Fitting System",
        cat: "Containment Fittings",
        desc: "Pre-formed smooth-radius curved fittings ensuring compliant bending radius for high-voltage and low-voltage armoured power cables without conductor pinching.",
        image: "/images/products/containment_fittings.jpeg",
        specs: [
          ["Fitting Types", "90° Flat Bends, Equal Tees, 4-Way Crosses"],
          ["Bending Radius", "300mm / 450mm / 600mm Cable Friendly"],
          ["Jointing", "Pre-punched for Fishplate Couplers"],
          ["Fasteners", "M6 / M8 Smooth Head Carriage Bolts"],
        ],
      },
      {
        name: "Masar Inside & Outside Vertical Risers & Reducers",
        model: "Masar VR/OR Series",
        cat: "Vertical Transitions",
        desc: "Modular adjustable and fixed internal/external vertical risers for seamless elevation transitions across walls, risers, and structural beams.",
        image: "/images/products/containment_fittings.jpeg",
        specs: [
          ["Riser Angles", "30°, 45°, 90° Inside & Outside Transitions"],
          ["Reducers", "Straight, Left-Hand & Right-Hand Reducers"],
          ["Locking", "Reinforced Splice Plate Fastening"],
          ["Material", "High-Grade Corrosion-Resistant Galvanised Steel"],
        ],
      },
      {
        name: "Masar Slotted Strut Channels & Cantilever Support Arms",
        ...
        specs: [
          ...
          ["Support Arms", "150mm to 1000mm Cantilever Arms"],
          ["Accessories", "Spring Channel Nuts, Threaded Rods, M10 Bolts"],
        ],
      },
      {
        name: "Masar Galvanised Snap-On & Flanged Tray Covers",
        ...
        specs: [
          ...
          ["Widths", "50mm to 900mm Matching Tray Widths"],
          ["Protection", "IP30 Mechanical & UV Sunlight Protection"],
        ],
      },
    ],
  },
